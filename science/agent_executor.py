...
class ScienceAgentExecutor(AgentExecutor):
    """Science Agent Executor using Gemini."""
    ...
    def __init__(self):
        ...
        if not self.api_key:
            ...
            self.model = genai.GenerativeModel(
                ...
                system_instruction="You are a knowledgeable science expert. Answer questions about physics, chemistry, biology, and other scientific fields clearly and accurately."
            )
